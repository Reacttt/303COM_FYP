...
class ShippingDetailsController extends Controller
{
    ...
    public function updateShippingDetails(Request $request)
    {
        ...
        DB::table('shipping_details')->where('shipping_details_id', $shipping_details_id)->update($data);

        return redirect('/shippingDetails')->with('alert', 'Shipping Details updated successfully!');
    }
